...
const { list, getById, create, update, remove, bulkRemove, generatePDF } = require('../controllers/proposalDocument.controller');
...
// POST /api/proposals/documents/bulk-delete - 제안서 일괄 삭제
